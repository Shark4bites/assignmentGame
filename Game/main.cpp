...
int main(int argc, char **argv)
{
	...
	for (int i = 0; i < 20; i++)
	{
		...
		for (int ii = 0; ii < 10; ii++)
		{
			...
			panel->pos.x = (ii * 20) + 60;
			panel->pos.y = 420 - (i * 20);
			if (panel != NULL)
				cout << ii+1 << " ";
			panels[i][ii] = panel;
	...
	if (block != NULL)
		cout << "Construction block created!" << endl;
	else
		cout << "Coonstruction block failed!" << endl;
	/*-----------------------------------------------------------------------------------------------------------------------------------------
	MAIN GAME LOOP
	-----------------------------------------------------------------------------------------------------------------------------------------*/
	...
	while (loop)
	{
		...
		SDL_Event event;
		while (SDL_PollEvent(&event) && delayC >= delay){
